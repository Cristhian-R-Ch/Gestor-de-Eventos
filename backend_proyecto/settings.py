...
SECRET_KEY = 'django-insecure-wey_y$w=2(x^d@3mp8+!m6eop_ju(n@0t_$4ky7g*)a7$t3l=x'
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': (
        # REGLA: Si no envías Token, no entras a ninguna API (401 Unauthorized)
        'rest_framework.permissions.IsAuthenticated',
    ),
    'DEFAULT_AUTHENTICATION_CLASSES': (
        # Decimos a DRF que use el sistema de Tokens que activamos antes
        'rest_framework.authentication.TokenAuthentication', # React/Postman se conecte
